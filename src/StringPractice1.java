public class StringPractice1 {
    ...
    static String Red, Orange;
    static String dog, newString; //declared variable for question 10
    static String Replace; //declared variable for question 11

    static StringPractice1 stringPractice1 = new StringPractice1(); // created object

    public static void main(String[] args) {   // main method

        stringPractice1.joinString();  // calling methods

        stringPractice1.specifiedValue();
        stringPractice1.symbolRemoval();
        stringPractice1.stringEnd();
    ...
    public void symbolRemoval()
    {
        ...
        System.out.println("New:" +old.replaceAll("are","is"));
    }
    ...
    static void color()
    {
       ...
       System.out.println("Red is favourite color.starts with Red? "+Red.startsWith("R"));
    ...
    public void practise()
    {
        string1="Krishna";
        string2="lilly";
        System.out.println("The names are " +string1 + " "+string2);
