public class StringPractice1409
{
        ...
        static StringPractice1409 stringPractice1409 = new StringPractice1409(); // created object
        public static void main(String[] args) {  // main method

            stringPractice1409.joinString(); // calling methods
            stringPractice1409.specifiedValue();
            stringPractice1409.symbolRemoval();
            stringPractice1409.stringEnd();
            stringComparison();
            Number();
            lengthOfString();
            color();
